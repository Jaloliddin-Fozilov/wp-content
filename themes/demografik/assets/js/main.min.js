...
$('.counter-options  button').click(function(){
    var pos= $(this).index();
    var desc= $(this).data('desc');
    $('.counter div').removeClass('active');
    $('.counter div').eq( pos ).addClass('active');
    $('.counter-main .counter-title').html(desc);
})
...
jQuery(document).ready(function($) {
    ...
    $(".owl-slider-unsd-dssb").owlCarousel({
        items: 1,
        navigation: false, 
        slideSpeed: 300,
        loops: true,
...
jQuery(document).ready(function($) {
    ...
    function onScrollHandle() {
        ...
        $('.o-article__body-nav a').each(function () {
            var curLink = $(this);
            var refElem = $(curLink.attr('href'));
            //Compare the value of current position and the every section position in each scroll
            if (refElem.position().top <= currentScrollPos && refElem.position().top + refElem.height()+500 > currentScrollPos) {
                //Remove class active in all nav
                $('.o-article__body-nav a').removeClass("s-active");
                //Add class active
                curLink.addClass("s-active");
            }
            else {
                curLink.removeClass("s-active");
            }
        });
    }
});