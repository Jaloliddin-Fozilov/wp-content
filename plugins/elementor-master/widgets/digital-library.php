...
class Widget_Digital_Library extends Widget_Base {
	...
	// 	wp_register_script('slick.slider', plugins_url( '/assets/js/slick.min.js', ELEMENTOR_MASTER ), array(), '1.0.0');
                                                ...
                                                <div class="header d-flex-between pt-4 pb-3">
                                                    <h3 class="title">
                                                        <a href="<?php the_permalink(); ?>">
														    <?php $in = get_the_title(); ?>
															<?php echo $out = strlen($in) > 45 ? substr($in,0,45)."..." : $in; ?>
                                                        </a>
                                                    </h3>
                                                </div>
